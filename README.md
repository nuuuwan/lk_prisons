...
![Latest Data](https://img.shields.io/badge/latest_data-2026--09--15-green)
![Last Checked](https://img.shields.io/badge/last_checked-2026--09--15-purple)
...
{
  "date_str": "2026-09-15",
  "convicted_male": 10536,
  "convicted_female": 253,
  "convicted_total": 10789,
  "unconvicted_male": 25418,
  "unconvicted_female": 1718,
  "unconvicted_total": 27136,
  "total_male": 35954,
  "total_female": 1971,
  "total_total": 37925,
  ...
  "unconvicted_release_on_bail_male": 501,
  "unconvicted_release_on_bail_female": 28,
  "unconvicted_release_on_bail_total": 529
}
```

## Charts

All charts below describe the prison population and releases recorded on **2026-09-15**.
...
pie showData title Releases: Released vs Bail
    ...
    "Released on Bail (Unconvicted)" : 529
```
